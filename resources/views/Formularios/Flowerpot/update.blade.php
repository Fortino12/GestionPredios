    ...
    <section>
        <div class="wrap_for">
            ...
            <div class="form">
                ...
                <form action="{{route('flowerpot.edit',$flowerpot['id'])}}" method="post">
                    @csrf
                    @method('put')
                    <div class="input_field">
                        <label for="nombreMacetero">Nombre del Macetero</label>
                        <input type="text" name="nombreMacetero" class="input" value="{{old('nombreMacetero'$flowerpot['nombreMacetero'])}}">
                    </div>
                    <div class="input_field">
                        <label>Plaga</label>
                    ...
                    <div class="input_field">
                        <input type="submit" value="Actualizar Macetero" class="btn">
                    </div>
                </form>
            </div>
        </div>
