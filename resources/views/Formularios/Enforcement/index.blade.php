...
@section('contenido')
    <div class="title1">
        <h2><a href="{{route('enforcement.create')}}">Trabajadores</h2></a>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$enforcement->area->descripcion}}</td>
    ...
    <div class="btn_container">
        <a href="{{route('enforcement.create')}}" class="banner-btn" style="float: right;">Agregar</a> 
    </div>  
